...
![Images of varying resolutions ($10 \times 10$, $20 \times 20$, $40 \times 40$, $80 \times 80$, and $160 \times 160$ pixels).](https://doc.shiyanlou.com/courses/2777/246442/e13bbae637400a50316e3ee3ec167df2-0)
...
Say that we cast a dice and want to know what the chance is of seeing a 1 rather than another digit. If the dice is fair, all the six outcomes $\{1, \ldots, 6\}$ are equally likely to occur, and thus we would see a $1$ in one out of six cases. Formally we state that $1$ occurs with probability $\frac{1}{6}$.
...
The following table lists such conditional probabilities.
